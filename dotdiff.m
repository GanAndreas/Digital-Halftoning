...
%Diffusion Matrix
  ...
  for ii=0:1:nn
      [p1,p2]=(find(CM==ii)); %finding the location of every dot
  ...
  im1=imgaussfilt(im1,'FilterSize',7);
  H=imgaussfilt(H,'FilterSize',7);
  
  [peaksnr, snr] = psnr(im1, H);
  fprintf('\n The Peak-SNR value is %0.4f. \n', peaksnr);
  
  imshow(H),figure,imshow(im1);
